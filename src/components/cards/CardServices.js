    ...
    className="pb-32 grid grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-10 lg:grid-cols-3 xl:gap-y-14 ">
      {Dataservices.map((service, index) => (
        <motion.div
          ...
          key={index}
          className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-[#222] dark:border-[#333] text-center lg:p-20 xl:max-w-md relative group overflow-hidden"
        >
